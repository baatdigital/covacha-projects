...
| EP-SP-020 | mf-sp - Pantallas de Cash, Subasta y Config IA | L | 7-9 | EP-SP-007, EP-SP-015, EP-SP-016, EP-SP-017 | **COMPLETADO (frontend)** |
...
> **Estado: COMPLETADO (frontend)** — CashConfigPageComponent implementado 2026-02-27 con 3 tabs (Cash In/Out, Subasta, Config IA). Ruta: `/sp/admin/cash-config`.
